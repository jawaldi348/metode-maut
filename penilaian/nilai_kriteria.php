...
<div class="form-group">
    ...
    <?php } else if($idkriteria =='K-003'){?>
        <input type="radio" name="nilai" id="nilai" value="1"> 151 mm - 200 mm<br>
        <input type="radio" name="nilai" id="nilai" value="2"> 201 mm - 400 mm<br>
    ...
    <?php } else if($idkriteria =='K-006'){?>
        <input type="radio" name="nilai" id="nilai" value="1"> Tinggi<br>
        <input type="radio" name="nilai" id="nilai" value="2"> Menengah<br>
        <input type="radio" name="nilai" id="nilai" value="3"> Rendah<br>
    <?php }?>
</div>